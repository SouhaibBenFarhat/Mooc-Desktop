 ...
 */
package com.esprit.mooc.ressources;
...
public class config2 {
    ...
    public void loadPane(Pane ap,FXMLLoader loader){
        try {
            Pane p = loader.load();
            ap.getChildren().setAll(p);
        } catch (IOException e) {
    ...
    public void loadPane(Pane ap,String a){
        try {
            Pane p = FXMLLoader.load(getClass().getResource(a));
            ap.getChildren().setAll(p);
        } catch (IOException e) {
        }   
    }
