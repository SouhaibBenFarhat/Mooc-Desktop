...
//    public TableView<Utilisateur> tableEntreprise;
   ...
   // List<Utilisateur> lFormateur=userDao.findAllUtilisateur();
    List<Utilisateur> lFormateur=userDao.findUtilisateurByRole("ROLE_ENTREPRISE");
...
//        id = u.getId();
    ...
    public void refreshtable(){
        ...
        ObservableList<Utilisateur> list=FXCollections.observableArrayList(userDao.findAllUtilisateur()); 
