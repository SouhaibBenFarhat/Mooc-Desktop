...
import ressources.FadeInUpTransition;
import java.net.URL;
...
//        w = 0.1;
//        h = 0.1;
        listMenu.getItems().addAll("Apprenant", "  Formateur","  Entreprise");
//        Platform.runLater(() -> {
...
//            resize.setVisible(false);
            ...
            con.loadPane(paneData, "/com/esprit/mooc/moocfx_1/inscriptionApprenant.fxml");
...
//    }
    ...
    @FXML
    private void menuKlikListMenu(MouseEvent event) {
        switch(listMenu.getSelectionModel().getSelectedIndex()){
            case 0:{
                con.loadPane(paneData, "/com/esprit/mooc/moocfx_1/inscriptionApprenant.fxml");
            }break;
            case 1:{
                con.loadPane(paneData, "/com/esprit/mooc/moocfx_1/inscriptionFormateur.fxml");
            }break;
            case 2:{
                con.loadPane(paneData, "/com/esprit/mooc/moocfx_1/inscriptionEntreprise.fxml");
            }break;
        }
    }
